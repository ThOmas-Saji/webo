  ...
  return (
    <section className="rescommunity-container">
      ...
      <div className="employees-box">
        ...
        <div className="box-1">
          <Employees class="employee1" img={emp1} pos="SCIENTIST" res="Promoted a build to production" />
          </div>
        ...
        <div className="box-3">
        <Employees class="employee2" img={emp2} pos="Research Student" res="Promoted a build to production" />
        </div>

        <div className="box-4">
          <Employees class="employee3" img={emp3} pos="Product DESIGNER" res="Promoted a build to production" />
          </div>

        <div className="box-5">
        <Employees class="employee4" img={emp4} pos="ReSEARCHER" res="Promoted a build to production" />
        </div>
